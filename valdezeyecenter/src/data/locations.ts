...
export const locations: Location[] = [
  {
    title: 'Our Clinic',
    imageSrc: Clinic,
    directions: 'We are located west of St. Mary Medical Center. When you reach the hospital, you can take Outer Highway 18 and turn on Tuscola Road and you\'ll find us next to the Knolls Medical Center.',
    ...
    link: 'https://goo.gl/maps/c2663pPazi36HoCk9'
  },
  {
    title: 'Neighboring Surgery Center',
    imageSrc: AppleValleySurgeryCenter,
    directions: 'The closest Surgery Center is in Apple Valley, located on outer Highway 18 just a block away from St. Mary Medical Center.',
    ...
    link: 'https://goo.gl/maps/Aq57B2pABLbnThYB9'
  },
  {
    title: 'Other Surgery Center',
    imageSrc: VictorvilleSurgeryCenter,
    directions: 'The other Surgery Center we use is in Victorville, located in the Wells Fargo complex.',
    ...
    link: 'https://goo.gl/maps/X1X9rNmm1A5tgGEv9'
  },
];
