    ...
    <div className="flex flex-col gap-12 w-2/3">
      ...
      {randomCondition.smokingCessation && (
        <p className="text-red-600 text-lg">
          ...
          Learn more about <Link href={randomCondition.smokingCessation.url} className="underline text-blue-600 hover:text-blue-400" target="_blank" rel="noopener noreferrer">smoking cessation</Link>.
        </p>
      )}
